...
## Project Structure
    ...
    ├── ideapros_llc_octane_31961  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_octane_31961`
...
2. Clone this repo and `cd ideapros_llc_octane_31961`
